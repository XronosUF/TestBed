...
\begin{problem}
Determine if the limit approaches a finite number, infinity, or does not exist. (If the limit does not exist, write DNE)  \begin{flushright}Click on the arrow to the right for some help.\end{flushright}\vspace{5pt}
\begin{hint}
