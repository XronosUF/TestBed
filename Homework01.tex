...
\begin{problem}
\ifshuffle {dana - shuffle true} \else {dana - shuffle false} \fi
\ifhandout {dana - handout true} \else {dana - handout false} \fi
\iffirstproblem {dana - first true} \else {dana - first false} \fi
