...
\begin{problem}
\ifshuffle {dana - if shuffle true} \else {dana - if shuffle false} \fi
\iffirstproblem {dana - if firstproblem  true} \else {dana - if firstproblem false} \fi
%%%%\ifthenelse{\ifshuffle}{dana - if shuffle true}{dana - if shuffle false}
%%% \ifthenelse{\iffirstproblem}{dana - if firstproblem  true}{dana - if firstproblem false}
